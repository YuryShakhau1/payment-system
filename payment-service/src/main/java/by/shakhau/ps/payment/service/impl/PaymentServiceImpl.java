...
public class PaymentServiceImpl implements PaymentService {
    ...
    private final UserSumMapper userSumMapper;
    ...
    @Override
    public Page<UserSum> getTotalSum(
        ...
        List<UserSum> finalContent = results.getMappedResults().stream()
                .map(userSumMapper::toModel)
                .map(this::fillUser)
                .toList();
    ...
    private UserSum fillUser(UserSum userSum) {
        userSum.setUser(userService.fetchById(userSum.getId()));
        return userSum;
    }
}
